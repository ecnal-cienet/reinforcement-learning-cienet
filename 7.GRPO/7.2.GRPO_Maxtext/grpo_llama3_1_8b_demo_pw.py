...
MODEL_CHECKPOINT_PATH = "gs://lance-maxtext/llama3.1-8b-Instruct/scanned-pathways/0/items"
...
# ===== Profiling =====
PROFILE_DIR = f"gs://lance-maxtext/grpo/v5p-64/llama3-1-8b/profile_dir/{run_id}/profiles_llama3/"
if not epath.Path(PROFILE_DIR).exists():
  epath.Path(PROFILE_DIR).mkdir(parents=True)

# ====== Checkpoint saving ======
CKPT_DIR = f"gs://lance-maxtext/grpo/v5p-64/llama3-1-8b/ckpt_save_dir/{run_id}/ckpts_llama3/"
